...
<head>
    <meta charset="utf-8" />
    <title>Legal Information - Bixa</title>
...
<body data-layout-mode="<?= get_cookie('theme') ?? 'light' ?>" class="bg-soft-light">
    <div class="py-5">
        <div class="container">
            <!-- Header -->
            <div class="text-center mb-5">
                <a href="<?= base_url() ?>" class="d-block auth-logo mb-4">
                    <img src="<?= base_url() ?>assets/<?= $this->base->get_template() ?>/images/logo-sm.svg" alt="" height="30">
                </a>
                <h3 class="mb-3">Legal Information</h3>
...
<div class="terms-content">
    ...
    <p><strong>Last updated: <?= date('F d, Y') ?></strong></p>
            ...
            <div class="text-center mt-5">
                <p class="mb-0">© <?= date('Y') ?> Bixa. All rights reserved.</p>
            </div>
        </div>
    </div>
