...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Email Verification | <?= $this->base->get_hostname() ?></title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="<?= base_url() ?>" class="d-block auth-logo">
                                            <img src="<?= base_url()?>assets/<?= $this->base->get_template() ?>/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Minia</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p>We have sent you verification email <span class="fw-bold"><?= $this->user->get_email() ?></span>, Please check it</p>
                                                <div class="mt-4">
                                                    <a href="<?= $mailbox_link ?>" class="btn btn-primary w-10">Verify email</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-5 text-center">
    <p class="text-muted mb-0">
        <a href="?resend=true" class="text-primary fw-semibold"><i class="bx bx-mail-send me-1"></i> Resend</a>
        <span class="mx-1">|</span>
        <a href="<?= base_url('verify?logout=true') ?>" class="text-primary fw-semibold"><i class="bx bx-log-out-circle me-1"></i> Logout</a>
    </p>
</div>
                                    </div>
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">"Our task must be to
                                                            ...
                                                            all living creatures and the whole of quis consectetur nunc sit amet semper justo. nature
                                                            and its beauty."</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">"I've learned that
                                                            ...
                                                            but people will never forget how donec in efficitur lectus, nec lobortis metus you made them
                                                            feel."</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <img src="<?= base_url()?>assets/<?= $this->base->get_template() ?>/images/users/avatar-3.jpg"
