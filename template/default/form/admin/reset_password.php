                    ...
                    <div class="w-100">
                        ...
                        <img src="<?= base_url()?>assets/<?= $this->base->get_template() ?>/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt"><?= $this->base->text('company', 'paragraph') ?></span>
                            ...
                            <div class="auth-content mt-2">
                                ...
                                <?= form_open('admin/reset/password/' . $token, ['class' => 'mt-4 pt-2']) ?>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <input type="submit" class="btn btn-primary w-100 waves-effect waves-light" name="reset" value="Reset Password">
                                    </div>
                                </form>
                            </div>
