            ...
            <div class="col-xxl-3 col-lg-4 col-md-5">
                <div class="auth-full-page-content d-flex p-sm-5 p-4">
                    <div class="w-100">
                        ...
                        <img src="<?= base_url()?>assets/<?= $this->base->get_template() ?>/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt"><?= $this->base->text('company', 'paragraph') ?></span>
                                </a>
                            </div>
                            <div class="auth-content mt-2">
                                <div class="text-center">
                                    <h5 class="mb-0"><?= $this->base->text('reset_password', 'heading') ?></h5>
                
                                </div>

                                <?= form_open('reset/password/' . $token, ['class' => 'mt-4 pt-2']) ?>
                                    <div class="mb-3">
...
<div class="input-group auth-pass-inputgroup">
    ...
    <button class="btn btn-light shadow-none ms-0" type="button" data-toggle="password1">
        <i class="fa fa-eye"></i>
                                    ...
                                    <div class="mb-3">
                                        <input type="submit" class="btn btn-primary w-100 waves-effect waves-light" name="reset" value="<?= $this->base->text('reset_password', 'button') ?>">
                                    </div>
                                </form>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> <?= $this->base->text('made', 'paragraph') ?> <?= $this->base->text('company', 'paragraph') ?></a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Lấy tất cả các button toggle password
    const toggleButtons = document.querySelectorAll('[data-toggle]');
    
    toggleButtons.forEach(button => {
        button.addEventListener('click', function() {
            // Lấy ID của input password từ data-toggle attribute
