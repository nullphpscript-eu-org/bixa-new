                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content mt-2">
                                <div class="text-center">
                                    <h5 class="mb-0"><?= $this->base->text('forget_password', 'heading') ?></h5>
                                    <p class="text-muted mt-2"><?= $this->base->text('forget_password', 'paragraph') ?></p>
                                </div>

                                <div class="alert alert-success text-center my-4" role="alert">
                                    <?= $this->base->text('forget_password', 'paragraph') ?>
                                </div>

                                <?= form_open('forget', ['class' => 'mt-4']) ?>
                                    <div class="mb-3">
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">
                                        <?= $this->base->text('forget_it', 'heading') ?>, 
