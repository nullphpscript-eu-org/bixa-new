...
.btn.btn-primary.active{color:#fff !important;}
    </style>
                                            ...
                                            <div class="card pricing-card mb-xl-0">
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <div class="mt-4">
														<a href="/u/create_account" 
                                                            <button class="btn btn-light w-100">Continue with Free Plan</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<center><?php display_ad('footer'); ?></center>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            © <?= date('Y') ?> <?= $this->base->get_hostname() ?>.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                <?= $this->base->text('copyright', 'label') ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const layoutMode = document.querySelector('body').getAttribute('data-layout-mode');
        if (layoutMode === 'dark') {
        ...
        document.addEventListener('click', function(e) {
            if (
                ...
                !e.target.closest('.vertical-menu') &&
